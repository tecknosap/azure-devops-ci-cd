...
module "sql_database" {
  ...
  sql_server_name     = "${var.sql_server_name}-${random_id.suffix.hex}"
  admin_username      = var.server_user_name 
  admin_password      = module.sql_database.out_administrator_login_password
  database_name       = "${var.sql_database_name}-${random_id.suffix.hex}"
}

# =====================================================
# Key Vault module usage
# =====================================================
module "key_vault" {
